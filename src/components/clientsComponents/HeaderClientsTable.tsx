...
const HeaderClientsTable = ({ label }: propsHead) => {
  return (
    <div className="flex items-center justify-between flex-wrap mb-4 overflow-auto">
      ...
      <div className="flex items-center justify-center gap-2">
        ...
        >
          ...
          <option value="المدينة1">المدينة 1</option>
          <option value="المدينة2">المدينة 2</option>
          <option value="المدينة3">المدينة 3</option>
        </select>
        <select
          className="pl-3 pr-2 py-2 rounded-lg border-[1px] border-[#E6E6E6] text-xs font-normal outline-none"
