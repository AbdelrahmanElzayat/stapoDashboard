...
import HeaderClientsTable from "./HeaderClientsTable";
import { ClientsType } from "@/utils/types/HeaderInfoType";
...
const ClientsTable = <T extends ClientsType>({
  data,
  label,
}: ReqTableProps<T>) => {
  ...
  return (
    <div className="w-full rounded-[14px] mt-4 border-[1px] border-[#e6e6e6] mx-auto p-4 text-right">
      <HeaderClientsTable label={label} />
