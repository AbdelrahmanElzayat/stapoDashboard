...
const SideBar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:relative top-0 left-0 z-50 bg-white lg:bg-transparent shadow-lg lg:shadow-none transform flex flex-col gap-6 pt-5 pb-7 lg:min-h-[calc(100vh-32px)] max-h-[100vh] lg:max-h-full overflow-y-auto ${
