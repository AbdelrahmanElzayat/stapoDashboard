...
import { Notifications } from "@/utils/types/HeaderInfoType";
...
const NotificationsTable = <T extends Notifications>({
  data,
  label,
}: ReqTableProps<T>) => {
  ...
  return (
    <div className="w-full rounded-[14px] mt-4 border-[1px] border-[#e6e6e6] mx-auto p-4 text-right">
      <FilterNotificationsTable label={label} />
