            ...
            <div className={`bg-white pb-4 pt-5 p-4 ${style.profileAmount}`}>
              ...
              <div className="btns flex flex-row justify-center items-center gap-3 mt-3">
                <button
                  ...
                  className=" justify-center rounded-lg bg-[#F5D446] py-2 px-6 text-sm font-semibold text-black shadow-sm hover:bg-[#F5D446bc]"
                >
                  تأكيـد الطلـب
                </button>
                <button
                  ...
                  data-autofocus
                  onClick={() => setOpen(false)}
                  className="mt-3 flex-grow  border border-[#C5C5C5] outline-none justify-center rounded-lg bg-[#F3F6F5] py-2 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-50 sm:mt-0 sm:w-auto"
                >
